...
>
	...
	<div
		class="jet-apb-config-popup"
		v-show="configVisible"
	>
		<h4><?php esc_html_e( 'General settings', 'jet-appointments-booking' ); ?></h4>
		<label>
			<input
				type="checkbox"
				name="groupView"
				v-model="groupView"
			>
			<?php esc_html_e( 'Show groups', 'jet-appointments-booking' ); ?>
		</label>
		
		<h4><?php esc_html_e( 'Filter Visibility', 'jet-appointments-booking' ); ?></h4>
		<ul>
