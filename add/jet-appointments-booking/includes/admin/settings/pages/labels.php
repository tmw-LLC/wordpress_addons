...
class Labels extends Appointment_Settings_Base {
	...
	public function get_page_slug() {
		return 'jet-apb-labels-settings';
	}
	...
	public function get_page_name() {
		return esc_html__( 'Labels', 'jet-dashboard' );
	}
	...
	public function page_templates( $templates = array(), $page = false, $subpage = false ) {
		$templates['jet-apb-labels-settings'] = JET_APB_PATH .'templates/admin/jet-apb-settings/settings-labels.php' ;
